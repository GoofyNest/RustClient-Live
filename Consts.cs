...
public static class Consts // TypeDefIndex: 11535
{	// Fields
	...
	public static readonly bool ProceduralObjectsVisibleInEditor; // 0x0
	public static readonly Color FlatColor; // 0x4
	...
	public const MeshType GeomMeshType = 0;
	...
	public const AttenuationEquation AttenuationEquationDefault = 1;
	public const float AttenuationCustomBlending = 0,5;
	public const float FadeStart = 0;
	public const float FadeEnd = 3;
	public const float FadeMinThreshold = 0,01;
	...
	public static readonly Vector3 NoiseVelocityDefault; // 0x14
	public const BlendingMode BlendingModeDefault = 0;
	public static readonly BlendMode[] BlendingMode_SrcFactor; // 0x20
	public static readonly BlendMode[] BlendingMode_DstFactor; // 0x28
	public static readonly bool[] BlendingMode_AlphaAsBlack; // 0x30
	...
	public const RenderQueue ConfigGeometryRenderQueueDefault = 3000;
	...
	// RVA: 0x1118840 Offset: 0x1117C40 VA: 0x181118840
	public static HideFlags get_ProceduralObjectsHideFlags() { }

	// RVA: 0x11186A0 Offset: 0x1117AA0 VA: 0x1811186A0
