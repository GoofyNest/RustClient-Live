...
public enum ServerQuerySet // TypeDefIndex: 5699
{
	public int value__; 
...
public struct ServerParameters // TypeDefIndex: 5707
{
	[CompilerGeneratedAttribute] 
...
public static class ServerInfoExtensions // TypeDefIndex: 6161
{
...
private struct ServerInfoExtensions.<QueryRulesAsync>d__0 : IAsyncStateMachine // TypeDefIndex: 6162
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<Dictionary<string, string>> <>t__builder; 
...
public static class ServerListMetadata // TypeDefIndex: 6215
{
	[CompilerGeneratedAttribute] 
...
private sealed class ServerListMetadata.<>c // TypeDefIndex: 6216
{
...
public class ServerGib : IDisposable, Pool.IPooled, IProto // TypeDefIndex: 6334
{
...
public abstract class Server : BaseNetwork // TypeDefIndex: 6872
{
...
public class ServerVar : ConsoleVar // TypeDefIndex: 6924
{
...
public class ServerUserVar : ConsoleVar // TypeDefIndex: 6925
{
...
public class ServerAllVar : ConsoleVar // TypeDefIndex: 6926
{
...
public class Server : Server // TypeDefIndex: 7340
{
	private Peer peer; 
...
public class ServerConsole : SingletonComponent<ServerConsole> // TypeDefIndex: 11008
{
...
public class ServerGib : BaseCombatEntity // TypeDefIndex: 11324
{
...
public class ServerProjectile : EntityComponent<BaseEntity>, IServerComponent // TypeDefIndex: 11401
{
...
public class ServerMgr : SingletonComponent<ServerMgr> // TypeDefIndex: 12440
{
...
public class ServerPerformance : BaseMonoBehaviour // TypeDefIndex: 12441
{
...
public class ServerBrowser : MonoBehaviour // TypeDefIndex: 12897
{
	public string orderBy; 
	private string searchText; 
	private bool showFull; 
	private bool showEmpty; 
	private List<HashSet<string>> searchTags; 
...
public class ServerBrowserCategory : MonoBehaviour // TypeDefIndex: 12898
{
...
private sealed class ServerBrowserCategory.<>c // TypeDefIndex: 12899
{
...
public class ServerBrowserInfo : SingletonComponent<ServerBrowserInfo> // TypeDefIndex: 12900
{
	public bool isMain; 
...
private struct ServerBrowserInfo.<QueryRules>d__19 : IAsyncStateMachine // TypeDefIndex: 12901
{
	public int <>1__state; 
...
public class ServerBrowserItem : MonoBehaviour // TypeDefIndex: 12902
{
...
private sealed class ServerBrowserItem.<>c // TypeDefIndex: 12903
{
...
public class ServerBrowserList : BaseMonoBehaviour, VirtualScroll.IDataSource // TypeDefIndex: 12904
{
	...
	public void InitFilters(string searchFilter, bool showFull, bool showEmpty, List<HashSet<string>> searchTags, HashSet<string> excludeTags) { }
	...
	public void SearchFilter(string searchtext, bool showFull, bool showEmpty, List<HashSet<string>> searchTags, HashSet<string> excludeTags) { }
...
public enum ServerBrowserList.QueryType // TypeDefIndex: 12905
{
	public int value__; 
...
public struct ServerBrowserList.ServerKeyvalues // TypeDefIndex: 12906
{
	public string key; 
	public string value; 
...
public struct ServerBrowserList.Rules // TypeDefIndex: 12907
{
	public string tag; 
...
private class ServerBrowserList.HashSetEqualityComparer<T> : IEqualityComparer<HashSet<T>> // TypeDefIndex: 12908
{
	[CompilerGeneratedAttribute] 
	private static readonly ServerBrowserList.HashSetEqualityComparer<T> <Instance>k__BackingField; 

	public static ServerBrowserList.HashSetEqualityComparer<T> Instance { get; }


	[CompilerGeneratedAttribute] 
	public static ServerBrowserList.HashSetEqualityComparer<T> get_Instance() { }
	/* GenericInstMethod :
	|
	|-ServerBrowserList.HashSetEqualityComparer<object>.get_Instance
	|-ServerBrowserList.HashSetEqualityComparer<string>.get_Instance
	*/

	public bool Equals(HashSet<T> x, HashSet<T> y) { }
	/* GenericInstMethod :
	|
	|-ServerBrowserList.HashSetEqualityComparer<object>.Equals
	*/

	public int GetHashCode(HashSet<T> set) { }
	/* GenericInstMethod :
	|
	|-ServerBrowserList.HashSetEqualityComparer<object>.GetHashCode
	*/

	public void .ctor() { }
	/* GenericInstMethod :
	|
	|-ServerBrowserList.HashSetEqualityComparer<object>..ctor
	*/

	private static void .cctor() { }
	/* GenericInstMethod :
	|
	|-ServerBrowserList.HashSetEqualityComparer<object>..cctor
	*/

}

private sealed class ServerBrowserList.<>c // TypeDefIndex: 12909
{
	public static readonly ServerBrowserList.<>c <>9; 
	public static Func<Manifest.ServerDesc, string> <>9__10_0; 
	public static Func<ServerInfo, bool> <>9__40_1; 
	public static Func<ServerInfo, bool> <>9__40_2; 
	public static Func<ServerInfo, int> <>9__40_3; 
	public static Func<ServerInfo, uint> <>9__40_5; 
	public static Func<ServerInfo, uint> <>9__40_7; 
	public static Func<ServerInfo, bool> <>9__40_8; 
	public static Func<ServerInfo, uint> <>9__40_9; 
	public static Func<ServerInfo, bool> <>9__40_10; 
	public static Func<ServerInfo, uint> <>9__40_11; 
	public static Func<ServerInfo, string> <>9__40_12; 
	public static Func<ServerInfo, string> <>9__40_13; 
	public static Func<ServerInfo, int> <>9__40_14; 
	public static Func<ServerInfo, int> <>9__40_15; 
	public static Func<ServerInfo, int> <>9__40_16; 
...
private sealed class ServerBrowserList.<>c__DisplayClass11_0 // TypeDefIndex: 12910
{
...
private sealed class ServerBrowserList.<>c__DisplayClass40_0 // TypeDefIndex: 12911
{
...
public class ServerBrowserTag : MonoBehaviour // TypeDefIndex: 12912
{
...
public class ServerBrowserTagFilters : MonoBehaviour // TypeDefIndex: 12913
{
...
public class ServerBrowserTagGroup : MonoBehaviour // TypeDefIndex: 12914
{
	[TooltipAttribute] 
...
public class ServerBrowserTagList : MonoBehaviour // TypeDefIndex: 12915
{
...
public class ServerHistory : MonoBehaviour // TypeDefIndex: 12916
{
...
private struct ServerHistory.<Refresh>d__4 : IAsyncStateMachine // TypeDefIndex: 12917
{
	public int <>1__state; 
...
private sealed class ServerHistory.<>c // TypeDefIndex: 12918
{
...
public class ServerHistoryItem : MonoBehaviour // TypeDefIndex: 12919
{
	private ServerInfo serverInfo; 
	public Text serverName; 
	public Text players; 
...
public static class ServerInfoHelpers // TypeDefIndex: 12920
{
...
private struct ServerInfoHelpers.<Load>d__0 : IAsyncStateMachine // TypeDefIndex: 12921
{
	public int <>1__state; 
...
private struct ServerInfoHelpers.<LoadRules>d__1 : IAsyncStateMachine // TypeDefIndex: 12922
{
	public int <>1__state; 
	public AsyncTaskMethodBuilder<Dictionary<string, string>> <>t__builder; 
...
public static class Server // TypeDefIndex: 13399
{
...
public class Server : ConsoleSystem // TypeDefIndex: 13708
{
	[ServerVar] 
